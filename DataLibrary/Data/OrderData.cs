...
namespace DataLibrary.Data
{
    public class OrderData : IOrderData
    {
        ...
        {
            return dataAccess.SaveData("dbo.spOrders_UpdateName", new { Id = orderId, OrderName = orderName }, connectionString.SqlConnectionName);
        }
        public Task<int> DeleteOrder(int orderId)
        {
            return dataAccess.SaveData("dbo.spOrders_UpdateName", new { Id = orderId }, connectionString.SqlConnectionName);
        }
        public async Task<OrderModel> GetOrderById(int orderId)
        {
            var recs = await dataAccess.LoadData<OrderModel, dynamic>("dbo.spOrders_GetbyId", new
            {
                Id = orderId
